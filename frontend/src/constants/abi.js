...
const ABI = [
  ...
  { inputs: [], name: "CannotHireYourself", type: "error" },
  { inputs: [], name: "CommitNotFound", type: "error" },
  { inputs: [], name: "DeadlineTooFar", type: "error" },
  { inputs: [], name: "DeadlineTooSoon", type: "error" },
  { inputs: [], name: "FreelancerCannotCancelSubmitted", type: "error" },
  { inputs: [], name: "IncorrectETH", type: "error" },
  { inputs: [], name: "InsufficientStake", type: "error" },
  { inputs: [], name: "InvalidJob", type: "error" },
  { inputs: [], name: "InvalidJobState", type: "error" },
  { inputs: [], name: "InvalidReveal", type: "error" },
  { inputs: [], name: "InvalidScore", type: "error" },
  { inputs: [], name: "InvalidService", type: "error" },
  { inputs: [], name: "JobNotCancelled", type: "error" },
  { inputs: [], name: "JobNotCompleted", type: "error" },
  { inputs: [], name: "MetadataCidRequired", type: "error" },
  { inputs: [], name: "NotAllowed", type: "error" },
  { inputs: [], name: "NotReviewer", type: "error" },
  { inputs: [], name: "NotSubmitted", type: "error" },
  ...
  { inputs: [], name: "ReviewWindowNotClosed", type: "error" },
  { inputs: [], name: "ServiceNotAvailable", type: "error" },
  { inputs: [], name: "TokenUsed", type: "error" },
  { inputs: [], name: "TooEarlyForAutoRelease", type: "error" },
  { inputs: [], name: "TransferFailed", type: "error" },
  { inputs: [], name: "WorkCidRequired", type: "error" },
  { inputs: [], name: "WorkNotSubmitted", type: "error" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "address", name: "reviewer", type: "address" },
      { indexed: false, internalType: "address", name: "reviewee", type: "address" },
    ],
    name: "FeedbackTokenIssued",
    type: "event",
  },
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: "uint32", name: "jobId", type: "uint32" }],
    name: "JobCancelled",
    type: "event",
  },
  {
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "uint32", name: "serviceId", type: "uint32" },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "uint32", name: "jobId", type: "uint32" },
      { indexed: false, internalType: "bytes32", name: "workCid", type: "bytes32" },
    ],
    name: "WorkSubmitted",
    type: "event",
  },
  ...
  {
    inputs: [{ internalType: "uint32", name: "jobId", type: "uint32" }],
    name: "autoRelease",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    ...
    name: "clientRep",
    outputs: [
      { internalType: "uint256", name: "weightedScoreSum", type: "uint256" },
      { internalType: "uint256", name: "weightSum", type: "uint256" },
      { internalType: "uint128", name: "totalJobs", type: "uint128" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "getClientReputation",
    outputs: [
      { internalType: "uint256", name: "avgScoreScaled", type: "uint256" },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "enum FreelanceEscrow.JobStatus", name: "status", type: "uint8" },
          { internalType: "uint128", name: "amount", type: "uint128" },
          { internalType: "uint64", name: "deadline", type: "uint64" },
          { internalType: "uint64", name: "submittedAt", type: "uint64" },
          { internalType: "bytes32", name: "workCid", type: "bytes32" },
          { internalType: "bytes32", name: "jobDescription", type: "bytes32" },
        ],
        internalType: "struct FreelanceEscrow.Job",
        name: "",
        type: "tuple",
  ...
  },
  {
    ...
    name: "getJobTokens",
    outputs: [
      { internalType: "uint256", name: "clientToken", type: "uint256" },
      { internalType: "uint256", name: "freelancerToken", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "enum FreelanceEscrow.ServiceStatus", name: "status", type: "uint8" },
          { internalType: "uint88", name: "priceWei", type: "uint88" },
  ...
  {
    inputs: [
      { internalType: "uint32", name: "jobId", type: "uint32" },
      { internalType: "bytes32", name: "workCid", type: "bytes32" },
    ],
    name: "submitWork",
    outputs: [],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "bool", name: "applied", type: "bool" },
