    ...
    try {
      ...
      if (mode === 'jobs') {
        ...
        for (let i = 1; i <= cnt; i++) {
          ...
          let clientEmail = jobDescMeta.clientEmail ?? "";
          if (!clientEmail && j.client) {
            try {
              const clientProfileStr = localStorage.getItem(`profile_${j.client.toLowerCase()}`);
              if (clientProfileStr) {
                clientEmail = JSON.parse(clientProfileStr).email || "";
              }
            } catch (e) {}
          }
                  ...
                  <div className="fjob-card__body">
                    ...
                    {job.clientEmail && (
                      <div style={{
                        ...
                        <div>
                          <div style={{ fontSize: "11px", color: "var(--text2)", fontWeight: "600", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: "2px" }}>Client Contact</div>
                          <a 
